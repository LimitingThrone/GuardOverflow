...
/** People occasionally get the false impression that because STL and iterators
 ...
 *
 *  The "tiny" doubles we get are the result of reinterpreting the ghost of an
 *  int as a double -- see end.
 */
